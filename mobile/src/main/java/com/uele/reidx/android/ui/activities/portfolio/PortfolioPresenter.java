...
import io.reactivex.disposables.CompositeDisposable;
    ...
    public class PortfolioPresenter<V extends PortfolioReidxView> extends BasePresenter<V>
            implements PortfolioReidxPresenter<V> {

        private static final String TAG = PortfolioPresenter.class.getSimpleName();

        @Inject
        public PortfolioPresenter(DataManager dataManager,
