...
import io.reactivex.disposables.CompositeDisposable;
    ...
    public class PropertyPresenter<V extends PropertyReidxView> extends BasePresenter<V>
            implements PropertyReidxPresenter<V> {

        private static final String TAG = PropertyPresenter.class.getSimpleName();
