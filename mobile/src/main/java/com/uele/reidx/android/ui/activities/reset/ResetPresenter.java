...
public class ResetPresenter<V extends ResetReidxView> extends BasePresenter<V>
        implements ResetReidxPresenter<V> {

    private static final String TAG = ResetPresenter.class.getSimpleName();
