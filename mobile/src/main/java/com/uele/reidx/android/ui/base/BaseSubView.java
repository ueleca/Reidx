...
public abstract class BaseSubView
        extends ViewGroup implements SubReidxView {

    private ReidxView mParentReidxView;
    ...
    @Override
    public void attachParentScrView(ReidxView reidxView) {
        mParentReidxView = reidxView;
    }
}
