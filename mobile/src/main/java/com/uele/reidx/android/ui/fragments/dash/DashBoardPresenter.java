...
public class DashBoardPresenter<V extends DashBoardReidxView,
        I extends DashBoardReidxInteractor> extends BasePresenter<V, I>
        implements DashBoardReidxPresenter<V, I> {

    private static final String TAG = DashBoardPresenter.class.getSimpleName();

    @Inject
    public DashBoardPresenter(I reidxInteractor,
