...
package com.uele.reidx.android.ui.fragments.tabProfile;
...
public class TabProfileFragment
        extends BaseFragment implements TabProfileView {

    private LeadsActivity mLeadsProfileActivity;

    @Inject
    protected TabProfilePresenter mTabProfilePresenter;
